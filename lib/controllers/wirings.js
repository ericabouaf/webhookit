...
app.get('/wirings/new',app.require_login, function(req, res){
...
app.get('/wirings/:id/edit',app.require_login,get_wiring_collection,get_wiring, function(req, res){
	res.render('website/editor', {
		locals: {
		   title: 'Editor',
		   action: 'editor',
...
var mySimpleflowRunWithActivity = function(wiring, user_id, format, from, params, debug, wiring_collection, cb) {
	...
	mySimpleflowRun(wiring, params, debug, wiring_collection, function(results) {
				...
				if(format == "html") {
					...
					// Render the result of the "outputField" variable as a html document
						...
						// render run.ejs
						   ...
						   console.log("DA PARAMS", filteredParams);
