...
/*app.post('/wirings/:id/run.format', app.require_login, get_wiring_collection, get_wiring, function(req, res){
	run_wiring(req,res, req.param("format") );
});*/
