...
if (VERSION.indexOf('@') > -1) {
    VERSION = '3.5.0pr1'; // dev time hack for cdn test
}
...
YUI.add('yui', function(Y){}, '3.5.0pr1' ,{use:['yui-base','get','features','intl-base','yui-log','yui-later']});
...
}, '3.5.0pr1' ,{requires:['selector-native']});
...
}, '3.5.0pr1' ,{requires:['event-custom-base']});
...
}, '3.5.0pr1' ,{requires:['dom-core', 'selector']});
...
}, '3.5.0pr1' ,{requires:['dom-base', 'node-core', 'event-base']});
(function () {
...
}, '3.5.0pr1' ,{requires:['pluginhost-base']});
...
}, '3.5.0pr1' ,{requires:['node-base', 'event-delegate']});
...
}, '3.5.0pr1' ,{requires:['node-base', 'pluginhost']});
...
}, '3.5.0pr1' ,{requires:['node-base', 'dom-screen']});
...
}, '3.5.0pr1' ,{requires:['event-custom-base', 'querystring-stringify-simple']});
...
}, '3.5.0pr1' ,{requires:['selector-native', 'selector-css2']});
YUI.add('yui-log', function(Y) {
...
}, '3.5.0pr1' ,{use:['yui','oop','dom','event-custom-base','event-base','pluginhost','node','event-delegate','io-base','json-parse','transition','selector-css3','dom-style-ie','querystring-stringify-simple']});
var Y = YUI().use('*');
