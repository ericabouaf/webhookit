...
}, '3.5.0pr1' ,{skinnable:false, requires:['node']});
...
}, '3.5.0pr1' ,{skinnable:false, requires:['frame']});
...
YUI.add('editor', function(Y){}, '3.5.0pr1' ,{skinnable:false, use:['frame', 'selection', 'exec-command', 'editor-base', 'editor-para', 'editor-br', 'editor-bidi', 'editor-tab', 'createlink-base']});
